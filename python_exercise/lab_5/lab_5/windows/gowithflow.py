...
def delete_a_list_element(list_data, element_value):
    ...
    # 한 줄 이상의 코드로 작성 가능하나,
    # 반드시 결과 값을 result 변수에 할당하여 반환
    length_of_list_data = len(list_data)
    for i in list_data:
        if i==element_value:
    ...
    if(length_of_list_data == len(list_data)):
        return 0
...
def comparison_list_size(list_data_a, list_data_b):
    ...
    # 한 줄 이상의 코드로 작성 가능하나,
    # 반드시 결과 값을 result 변수에 할당하여 반환
    length_of_list_data_a = len(list_data_a)
    length_of_list_data_b = len(list_data_b)

    # ==================================
    if(length_of_list_data_a>=length_of_list_data_b):
        return list_data_a
    else:
        return list_data_b
